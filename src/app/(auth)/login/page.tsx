    ...
    <Form  {...form}>
        ...
        onSubmit={form.handleSubmit(onSubmit)} className='w-full sm:justify-center sm:w-[400px] space-y-6 flex flex-col' >
            ...
            render={(field) => (
                <FormItem>
                    <FormControl>
                        <Input className='rounded-xl border-purple-500 border' type='email' placeholder='Email' {...field} />
            ...
            render={(field) => (
                <FormItem>
                    <FormControl>
                        <Input className='rounded-xl border-purple-500 border' type='password' placeholder='Password' {...field} />
            ...
            <Button variant={'ownButton'} type='submit' className='w-full p-6 ' size={'lg'} disabled={isLoading} >
                {!isLoading ?  "Login" : <InfinitySpin
